                ...
                <div class="row">
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                      ...
                      <?php endif; ?>
                        <?php echo form_open(base_url('tempatpraktik/add')) ?>
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-2 col-sm-2 col-xs-12" for="alamat">Provinsi <span class="required">*</span></label>
                                <div class="col-md-5 col-sm-5 col-xs-12">
                                    <input type="text" name="provinsi" required="required" class="form-control">
                                </div>
                            </div><br /><br /><br />
